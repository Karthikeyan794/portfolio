...
| 5 | Assign & Notify | release `Team.notified.with.assigned.mp4` | 90 MB · 3188×2160 · 30s | **original, live on the release** — recorded against the real desk: colleagues’ names and work emails in the roster and the Teams sidebar |
| 6 | All thirteen filters, and the view you save them as | release `views.mp4` | 225 MB · 3644×2160 · 128s | **original, on the release** — checked: serves all 236,273,045 bytes, range requests answered |
| 7 | Merging duplicates, marking spam | release `merge.mp4` | 170 MB | **original, live on the release** |
| 8 | Who gets in, and what they may do | release `Profile.menu.+.manage.access.mp4` | 128 MB · 3636×2160 · 69s | **original, live on the release** — recorded against the demo |
